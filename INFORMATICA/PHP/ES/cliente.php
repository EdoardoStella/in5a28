...
<?php 
   ...
   case "listaCliente": {
         ...
         $sql = "SELECT c.Id, c.ragioneSociale, c.indirizzo, c.numTelefono, c.partitaIva, c.idAgente, c.fido, l.cap, l.nome  
                  FROM ES_localita AS l, ES_cliente AS c
      ...
      ?>
         <form action="cliente.php" method="get">
            ...
            <?php
               ...
               $db = new mysqli(MYSQL_HOST, MYSQL_USER, MYSQL_PASSWORD, MYSQL_DB);
               $sql = "SELECT * FROM ES_localita ORDER BY nome ASC";
               $rs = $db->query($sql);
               $db->close();
               echo("\n\n");
   ...
   case "addCliente":{
      ...
      $sql = "INSERT INTO ES_cliente(ragioneSociale, indirizzo, numTelefono, partitaIva, idAgente, fido, idLocalita) 
