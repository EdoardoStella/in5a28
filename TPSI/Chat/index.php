...
<div class="container">			
		...
		<div class="chat">	
			<div id="frame">		
				<div id="sidepanel">
					...
					foreach ($loggedUser as $user) {
						...
						echo  '<p>'.$user['username'].'</p>';
							...
							echo '<ul>';
								...
								echo '<li id="status-away"><span class="status-circle"></span> <p>non disturbare</p></li>';
								echo '<li id="status-busy"><span class="status-circle"></span> <p>occupato</p></li>';
					...
					<div id="bottom-bar">	
						<button id="addcontact"><i class="fa fa-user-plus fa-fw" aria-hidden="true"></i> <span>Aggingi Contatto</span></button>
						<button id="settings"><i class="fa fa-cog fa-fw" aria-hidden="true"></i> <span>Impostazioni</span></button>					
					</div>
				</div>			
				<div class="content" id="content"> 
					...
					<div class="message-input" id="replySection">				
						<div class="message-input" id="replyContainer">
							<div class="wrap">
								<input type="text" class="chatMessage" id="chatMessage<?php echo $currentSession; ?>" placeholder="Scrivi il Messaggio..." />
	...
	<?php } else { ?>
		<br>
		<br>
		<strong><a href="login.php"><h3>Accedi alla chat</h3></a></strong>		
	<?php } ?>
	<br>
	<br>	
</div>	
